...
const randomRef = getRandomInt(1000);
		...
		_.forEach(
			...
			(value, key) => {
				if (typeof value === "string" && value[0] === ":") {
					filters[key] = {};
					var fieldName = value[1] === "!" ? value.slice(2) : value.slice(1);

					if (value[1] === "!") filters[key].inverted = true;
					...
					if (fieldName === "_id" && Keystone.item) {
						filters[key].value = Keystone.item.id;
						return;
					}
				} else {
